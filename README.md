...
| [`prototype/`](prototype/) | A clean, from-scratch reconstruction - pure static HTML/CSS/JS, every number fabricated, 64 screens, no build step. Live at <https://elsheraey.github.io/hexscout-autopsy/>, or open [`prototype/index.html`](prototype/index.html) locally. See [`prototype/README.md`](prototype/README.md). |
